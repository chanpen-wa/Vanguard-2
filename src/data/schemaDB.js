export const SYSTEM_CATEGORIES = [
  { id: 'BSI', name: '1. กระแสโลหิต (BSI/LCBI)' },
  { id: 'CVS', name: '2. หัวใจ/หลอดเลือด (CVS)' },
  { id: 'EENT', name: '3. ตา/หู/คอ/จมูก (EENT)' },
  { id: 'PNEU', name: '4. ทางเดินหายใจ (PNEU/VAP)' },
  { id: 'CNS', name: '5. ระบบประสาท (CNS)' },
  { id: 'SSI', name: '6. ตำแหน่งผ่าตัด (SSI)' },
  { id: 'UTI', name: '7. ทางเดินปัสสาวะ (UTI)' },
  { id: 'GI', name: '8. ทางเดินอาหาร (GI)' },
  { id: 'REPR', name: '9. อวัยวะสืบพันธุ์ (REPR)' },
  { id: 'OST', name: '10. กระดูก/ข้อ (OST)' },
  { id: 'OTHER', name: '11. การติดเชื้ออื่น ๆ' }
];

export const DEFAULT_CDC_DB = {
  'BSI': {
    "system_id": "BSI", "name": "1. การติดเชื้อในกระแสโลหิต (BSI / LCBI / CLABSI)",
    "rules": {
      "disease_paths": [
        {
  ...
  'GI': {
    "system_id": "GI", "name": "8. ทางเดินอาหาร (GI)",
    "rules": {
      "disease_paths": [
    ...
    "sections": [
      {
        ...
        "fields": [
          {
            "id": "gi_type", "type": "radio_select",
            "options": [
              { "label": "GE — Gastroenteritis (กระเพาะอาหาร/ลำไส้อักเสบ)", "value": "GE" },
              { "label": "CDI — C. difficile Infection (ติดเชื้อ Clostridioides difficile)", "value": "CDI" },
              { "label": "HEP — Hepatitis (ตับอักเสบ)", "value": "HEP" }
            ]
          }
        ]
      },
      {
        "id": "ge_criteria", "title": "Gastroenteritis (GE) — เกณฑ์การวินิจฉัย", "theme": "yellow", "depends_on": { "field": "gi_type", "value": "GE" },
        "fields": [
          { "id": "ge_culture_pos", "type": "checkbox", "label": "เกณฑ์ 1a: เพาะเชื้อจากอุจจาระ ได้ผลบวก" },
          { "id": "ge_swab_pos", "type": "checkbox", "label": "เกณฑ์ 1b: เพาะเชื้อจาก rectal swab ได้ผลบวก" },
          { "id": "ge_symp_group", "type": "checkbox", "label": "เกณฑ์ 2: อาการทางคลินิก (≥2) ร่วมกับผลห้องปฏิบัติการ (≥1)",
            "children": [
              ...
              { "id": "ge_diarrhea", "type": "checkbox", "label": "ท้องเสีย (อุจจาระเหลว/เป็นน้ำ ≥ 3 ครั้ง ใน 24 ชั่วโมง)" },
              ...
              { "id": "ge_antigen_pos", "type": "checkbox", "label": "ตรวจพบแอนติเจนหรือท็อกซิน (เช่น Rotavirus, Norovirus)" }
            ]
          }
        ]
      },
      {
        "id": "cdi_criteria", "title": "C. difficile Infection (CDI) — เกณฑ์การวินิจฉัย", "theme": "red", "depends_on": { "field": "gi_type", "value": "CDI" },
        "fields": [
           { "id": "cdi_diarrhea", "type": "checkbox", "label": "ท้องเสีย — อุจจาระเหลวพบบ่อย ≥ 3 ครั้ง ใน 24 ชั่วโมง" },
           { "id": "cdi_ileus", "type": "checkbox", "label": "ภาวะลำไส้อืดรุนแรง (Ileus)" },
           { "id": "alert_cdi_2", "type": "alert", "theme": "purple", "text": "หลักฐานยืนยันทางห้องปฏิบัติการ (ต้องมีอย่างน้อย 1 ข้อ)" },
           { "id": "cdi_toxin", "type": "checkbox", "label": "Stool toxin assay ให้ผลบวก (พบ Toxin A หรือ B)" },
           { "id": "cdi_pcr", "type": "checkbox", "label": "PCR/NAAT ตรวจพบยีนสร้างท็อกซินของ C. difficile เป็นบวก" },
           { "id": "cdi_culture", "type": "checkbox", "label": "เพาะเชื้อพบสายพันธุ์ C. difficile ที่สร้างท็อกซิน" }
        ]
      },
      {
        "id": "hep_criteria", "title": "Hepatitis (HEP) — เกณฑ์การวินิจฉัย", "theme": "blue", "depends_on": { "field": "gi_type", "value": "HEP" },
        "fields": [
           ...
           { "id": "hep_transfusion", "type": "checkbox", "label": "ได้รับเลือดหรือผลิตภัณฑ์เลือดใน 3 เดือนก่อนมีอาการ" }
        ]
      }
    ]
  },
  'PNEU': {
    "system_id": "PNEU", "name": "4. ทางเดินหายใจ (PNEU/VAP)",
  ...
  'UTI': {
    "system_id": "UTI", "name": "7. ทางเดินปัสสาวะ (SUTI/CAUTI)",
  ...
  'CVS': {
    "system_id": "CVS", "name": "2. หัวใจ/หลอดเลือด (CVS)",
    "rules": {
      "disease_paths": [
  ...
  'EENT': {
    "system_id": "EENT", "name": "3. ตา/หู/คอ/จมูก (EENT)",
    "rules": {
      "disease_paths": [
  ...
  'OST': {
    "system_id": "OST", "name": "10. กระดูก/ข้อ (OST)",
    "rules": {
      "disease_paths": [
    ...
    "sections": [
      {
        "id": "ost_selector", "title": "เลือกประเภท OST", "theme": "blue",
        "fields": [
          { "id": "ost_type", "type": "radio_select", "options": [ { "label": "BONE — Osteomyelitis (กระดูกอักเสบ)", "value": "BONE" }, { "label": "PJI — ติดเชื้อรอบข้อเทียม", "value": "PJI" }, { "label": "JNT — ข้อต่ออักเสบ", "value": "JNT" } ] }
        ]
      },
      {
        "id": "bone_sec", "title": "Osteomyelitis (BONE)", "theme": "amber", "depends_on": { "field": "ost_type", "value": "BONE" },
        "fields": [
          { "id": "bone_culture_pos", "type": "checkbox", "label": "เพาะเชื้อจากกระดูกได้ผลบวก" },
          { "id": "bone_pain", "type": "checkbox", "label": "บวม ปวด หรือกดเจ็บบริเวณกระดูก" },
          { "id": "bone_imaging_pos", "type": "checkbox", "label": "ภาพถ่ายรังสี (X-ray/MRI) ยืนยัน" }
        ]
      },
      {
        "id": "pji_sec", "title": "Periprosthetic Joint Infection (PJI)", "theme": "red", "depends_on": { "field": "ost_type", "value": "PJI" },
        "fields": [
          { "id": "pji_major", "type": "checkbox", "label": "Major: พบ Sinus tract หรือเพาะเชื้อตรงกัน ≥ 2 ชิ้น" },
          { "id": "alert_minor", "type": "alert", "theme": "blue", "text": "หรือมี Minor Criteria ครบ 3 ข้อ:" },
          { "id": "pji_minor_crp", "type": "checkbox", "label": "Minor: Elevated serum CRP และ ESR" },
          { "id": "pji_minor_wbc", "type": "checkbox", "label": "Minor: Elevated synovial WBC" },
          { "id": "pji_minor_culture", "type": "checkbox", "label": "Minor: เพาะเชื้อจากเนื้อเยื่อรอบข้อเทียมบวก 1 ชิ้น" }
        ]
      }
    ]
  },
  'REPR': {
    "system_id": "REPR", "name": "9. อวัยวะสืบพันธุ์ (REPR)",
    "rules": { "disease_paths": [] },
    "sections": [
      {
        "id": "repr_selector", "title": "เลือกประเภท REPR", "theme": "purple",
        "fields": [
          { "id": "repr_type", "type": "radio_select", "options": [ { "label": "VCUF — Vaginal cuff infection", "value": "VCUF" }, { "label": "ENDOM — Endometritis", "value": "ENDOM" }, { "label": "EPIS — Episiotomy infection (ฝีเย็บ)", "value": "EPIS" }, { "label": "OMPH — Omphalitis (สะดือทารก)", "value": "OMPH" } ] }
        ]
      }
    ]
  },
  'OTHER': {
    "system_id": "OTHER", "name": "11. การติดเชื้ออื่น ๆ",
    "rules": { "disease_paths": [] },
    "sections": [
      {
        "id": "other_selector", "title": "เลือกประเภท OTHER", "theme": "amber",
        "fields": [
          { "id": "other_type", "type": "radio_select", "options": [ { "label": "SKIN — Skin infection (ผิวหนัง)", "value": "SKIN" }, { "label": "ST — Soft tissue infection (เนื้อเยื่ออ่อน)", "value": "ST" }, { "label": "DECU — Decubitus ulcer (แผลกดทับ)", "value": "DECU" }, { "label": "BURN — Burn infection (แผลไฟไหม้)", "value": "BURN" } ] }
        ]
      }
    ]
  },
  'CNS': { "system_id": "CNS", "name": "5. ระบบประสาท (CNS)", "rules": { "disease_paths": [] }, "sections": [ { "id": "cns_init", "title": "โครงสร้างเบื้องต้น", "theme": "blue", "fields": [ { "id": "cns_sus", "type": "checkbox", "label": "สงสัยการติดเชื้อระบบประสาทส่วนกลาง" } ] } ] },
  'SSI': { "system_id": "SSI", "name": "6. ตำแหน่งผ่าตัด (SSI)", "rules": { "disease_paths": [] }, "sections": [ { "id": "ssi_init", "title": "โครงสร้างเบื้องต้น", "theme": "red", "fields": [ { "id": "ssi_sus", "type": "checkbox", "label": "สงสัยแผลติดเชื้อตำแหน่งผ่าตัด" } ] } ] }
};